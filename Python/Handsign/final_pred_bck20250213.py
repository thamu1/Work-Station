...
class Application:
    ...
    def __init__(self):
        ...
        self.speak.place(x=840, y=550)
        self.speak.config(text="Reply", font=("Courier", 20), wraplength=100, command=self.reply_fun)
    ...
    def reply_fun(self):
        ...
        reply = chatgpt.sign_call(self.str)
        
        print(f"QN : {self.str} \n Ans : {reply}")
        
        self.reply = tk.Button(self.root)
        self.reply.place(x=1120, y=115)
        self.reply.config(text=f"{reply}", font=("Courier", 10), wraplength=400, justify="left")
                
        # self.speak_engine.say(reply)
        # self.speak_engine.runAndWait()
